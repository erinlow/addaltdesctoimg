...
class Test_Plugin_Base extends \WP_UnitTestCase {
	...
	public function test_locate_plugin() {
		...
		$this->assertEquals( 'addaltdesctoimg', $location['dir_basename'] );
		$this->assertContains( 'plugins/addaltdesctoimg', $location['dir_path'] );
		$this->assertContains( 'plugins/addaltdesctoimg', $location['dir_url'] );
	}
	...
	public function test_relative_path() {
		$this->assertEquals( 'plugins/addaltdesctoimg', $this->plugin->relative_path( '/srv/www/wordpress-develop/src/wp-content/plugins/addaltdesctoimg', 'wp-content', '/' ) );
		$this->assertEquals( 'themes/twentysixteen/plugins/addaltdesctoimg', $this->plugin->relative_path( '/srv/www/wordpress-develop/src/wp-content/themes/twentysixteen/plugins/addaltdesctoimg', 'wp-content', '/' ) );
	}
	...
	public function test_add_doc_hooks_error() {
		$mock = $this->getMockBuilder( 'Addaltdesctoimg\Plugin' )->getMock();
		$obj = $this;
